...
def translate_text(text, target_language="sw"):
    ...
    try:
        ...
        return textcurl -X POST "https://4406-102-213-179-33.ngrok-free.app/ask" -H "Content-Type": "application/json" -d '{"question": "What is the right to life in the Kenyan Constitution?", "language": "sw"}'
